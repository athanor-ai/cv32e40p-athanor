...
OLD = """assign div_valid = enable_i & ((operator_i == ALU_DIV) || (operator_i == ALU_DIVU) ||
                     (operator_i == ALU_REM) || (operator_i == ALU_REMU));"""
NEW = "assign div_valid = enable_i & (operator_i[6:2] == 5'b01100);"
...
def main() -> int:
    ...
    receipt = {
        "candidate": "alu_divrem_prefix_valid",
        "module": "cv32e40p_alu",
