...
def main() -> int:
    ...
    receipt = {"candidate": "alu_shift_left_divrem_prefix", "scope": "default ALU parent context", "top": base["top"], "area": {"baseline": base["area"], "gate": gate["area"], "delta_pct": round(area_delta_pct, 6)}, "timing_slack": timing, "timing_flat_or_improved": not any(v["status"] == "regressed" for v in timing.values())}
