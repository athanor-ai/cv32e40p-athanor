...
REPLACEMENTS = [
    ('assign shift_use_round = (operator_i == ALU_ADD)   || (operator_i == ALU_SUB)   ||\n                           (operator_i == ALU_ADDR)  || (operator_i == ALU_SUBR)  ||\n                           (operator_i == ALU_ADDU)  || (operator_i == ALU_SUBU)  ||\n                           (operator_i == ALU_ADDUR) || (operator_i == ALU_SUBUR);', "assign shift_use_round = (operator_i[6:3] == 4'b0011);"),
    ('assign div_valid = enable_i & ((operator_i == ALU_DIV) || (operator_i == ALU_DIVU) ||\n                     (operator_i == ALU_REM) || (operator_i == ALU_REMU));', "assign div_valid = enable_i & (operator_i[6:2] == 5'b01100);"),
...
def main() -> int:
    ...
    receipt = {
        "candidate": "alu_addsub_divvalid_adderneg_prefixes",
        "module": "cv32e40p_alu",
