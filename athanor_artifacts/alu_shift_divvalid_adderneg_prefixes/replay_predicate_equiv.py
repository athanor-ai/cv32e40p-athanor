...
CASES = {
    ...
    "negative_shift_prefix_01101": {"path": ROOT / "predicate_equiv/negative_shift_prefix_01101", "expect": "fail"},
...
def main() -> int:
    ...
    receipt = {"candidate": "alu_shift_divvalid_adderneg_prefixes", "rows": rows, "expected_log_sha_fields": {k: v["log_sha"] for k, v in expected["rows"].items()}}
