...
GOLD = PACKAGE / 'gold_idstage_default.v'
GATE = PACKAGE / 'gold_idstage_default.v'
TOP = 'cv32e40p_id_stage'
OUT = Path(os.environ.get('OUT_DIR', str(PACKAGE / 'replay_out' / 'activity_aa')))
CYCLES = 750
SEED = 0x5eed3241
...
def main():
    ...
    receipt={
        ...
        'power_method':'cv32_idstage_register_file_context_iverilog_vcd_hierarchy_toggle_v1',
        'top':TOP,
        'sim_cycles':CYCLES,
        'stimulus':f'cv32.id_stage.regfile_read_write_mix+0x{SEED:x}',
    ...
    if counts['gold'] != 530322 or counts['gate'] != 530322:
