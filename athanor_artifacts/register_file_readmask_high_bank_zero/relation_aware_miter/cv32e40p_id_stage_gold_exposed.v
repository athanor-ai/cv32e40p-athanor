module cv32e40p_register_file_gold (
	clk,
	rst_n,
	scan_cg_en_i,
	raddr_a_i,
...
module cv32e40p_compressed_decoder_gold (
	instr_i,
	instr_o,
	is_compressed_o,
	illegal_instr_o
...
module cv32e40p_int_controller_gold (
	clk,
	rst_n,
	irq_i,
	irq_sec_i,
...
module cv32e40p_controller_gold (
	clk,
	clk_ungated_i,
	rst_n,
	fetch_enable_i,
...
module cv32e40p_hwloop_regs_gold (
	clk,
	rst_n,
	hwlp_start_data_i,
	hwlp_end_data_i,
...
module cv32e40p_id_stage_gold (
	...
	cv32e40p_int_controller_gold #(.PULP_SECURE(PULP_SECURE)) int_controller_i(
		.clk(clk),
		.rst_n(rst_n),
		.irq_i(irq_i),
		.irq_sec_i(irq_sec_i),
	...
	generate
		if (COREV_PULP) begin : gen_hwloop_regs
			cv32e40p_hwloop_regs_gold #(.N_REGS(N_HWLP)) hwloop_regs_i(
				.clk(clk),
				.rst_n(rst_n),
